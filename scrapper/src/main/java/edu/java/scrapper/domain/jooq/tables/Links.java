...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, OffsetDateTime> UPDATED_AT = createField(DSL.name("UPDATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINKS.LAST_CHECK</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_CHECK = createField(DSL.name("LAST_CHECK"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINKS.RESOURCE_TYPE</code>.
     */
    public final TableField<LinksRecord, ResourceType> RESOURCE_TYPE = createField(DSL.name("RESOURCE_TYPE"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(edu.java.scrapper.domain.jooq.enums.ResourceType.class), this, "");

    /**
     * The column <code>LINKS.GITHUB_UPDATED_AT</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> GITHUB_UPDATED_AT = createField(DSL.name("GITHUB_UPDATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");

    /**
     * The column <code>LINKS.STACKOVERFLOW_LAST_EDIT_DATE_QUESTION</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> STACKOVERFLOW_LAST_EDIT_DATE_QUESTION = createField(DSL.name("STACKOVERFLOW_LAST_EDIT_DATE_QUESTION"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super ResourceType, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super ResourceType, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
