...
public class ChatLinksRecord extends UpdatableRecordImpl<ChatLinksRecord> implements Record2<Long, Long> {
    ...
    @Override
    @NotNull
    public ChatLinksRecord values(@NotNull Long value1, @NotNull Long value2) {
        value1(value1);
        value2(value2);
        return this;
    }
    ...
    public ChatLinksRecord(@NotNull Long chatId, @NotNull Long linkId) {
        super(ChatLinks.CHAT_LINKS);
     ...
     * Create a detached, initialised ChatLinksRecord
     */
    public ChatLinksRecord(edu.java.scrapper.domain.jooq.tables.pojos.ChatLinks value) {
        super(ChatLinks.CHAT_LINKS);
